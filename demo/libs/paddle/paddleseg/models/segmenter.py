...
from demo.libs.paddle.paddleseg.cvlibs import manager, param_init
from demo.libs.paddle.paddleseg.models.backbones import vision_transformer, transformer_utils
